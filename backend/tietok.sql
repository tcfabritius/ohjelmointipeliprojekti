...
-- MariaDB dump 10.19  Distrib 10.6.19-MariaDB, for Win64 (AMD64)
--
...
CREATE TABLE `mission_accomplished` (
  ...
  KEY `goalid` (`mission_id`),
  CONSTRAINT `mission_accomplished_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `game` (`id`),
  CONSTRAINT `mission_accomplished_ibfk_2` FOREIGN KEY (`mission_id`) REFERENCES `mission` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-04 13:14:14
